...
// Disable automatic bandwidth compression
const char kDisableUbwc[] = "disable-ubwc";

// Set ubwc threshold
const char kUbwcThreshold[] = "ubwc-threshold";

// Set max texture dimensions for ubwc
const char kUbwcMaxSize[] = "ubwc-max-size";
