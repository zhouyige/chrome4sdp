...
public class SiteSettingsCategory {
    ...
    public static final String CATEGORY_XSS_DEFENDER = "xss_defender";
    ...
    public static SiteSettingsCategory fromString(String category) {
        ...
        if (CATEGORY_XSS_DEFENDER.equals(category)) {
            return new SiteSettingsCategory(CATEGORY_XSS_DEFENDER, "",
    ...
    public static SiteSettingsCategory fromContentSettingsType(int contentSettingsType) {
        ...
        if (contentSettingsType == ContentSettingsType.CONTENT_SETTINGS_TYPE_XSS_DEFENDER) {
            return fromString(CATEGORY_XSS_DEFENDER);
        }
    ...
    /**
     * @return whether this category is the XSS Defender category.
     */
    public boolean showXSSDefenderSites() {
        return mContentSettingsType ==
                ContentSettingsType.CONTENT_SETTINGS_TYPE_XSS_DEFENDER;
    }
