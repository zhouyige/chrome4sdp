...
int64_t OfflinePageInfoBarDelegate::GetTotalBytes() const {
  return 0;
}

std::string OfflinePageInfoBarDelegate::GetMimeType() const {
  return std::string();
}

bool OfflinePageInfoBarDelegate::SetDirFullPath(
