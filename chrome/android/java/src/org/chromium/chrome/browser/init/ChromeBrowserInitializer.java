...
import org.chromium.chrome.browser.preferences.LibswenetInitializer;
...
public class ChromeBrowserInitializer {
    ...
    static void initializeNetworkingModules(Context ctx) {
        // Libswenet
        Log.v("LIBNEXT", "initializeNetworkingModules");
        LibswenetInitializer.initializeGlobalInstance(ctx);
    }
        ...
        try {
            ...
            BrowserStartupController.get(mApplication, LibraryProcessType.PROCESS_BROWSER)
                    ...
                    public void onSuccess(boolean alreadyStarted) {
                        ...
                        initializeNetworkingModules(mApplication);
                    }
                });
        } finally {
