...
// static
void CommandLine::SetShouldCheckException() {
  is_crash_log_upload_enabled_ = HasSwitch(switches::kCrashLogServerUrl);
}

// static
bool CommandLine::IsShouldCheckException() {
  return is_crash_log_upload_enabled_;
}
