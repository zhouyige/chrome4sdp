...
class AndroidNetworkLibrary {
    ...
    /**
     * Adds an enterprise root certificate to the local trust store.
     * @param rootCert DER encoded bytes of the certificate.
     */
    @CalledByNativeUnchecked
    public static void addEnterpriseRootCertificate(byte[] rootCert) throws CertificateException,
            KeyStoreException, NoSuchAlgorithmException {
        X509Util.addEnterpriseRootCertificate(rootCert);
    }

    /**
     * Removes all enterprise root certificates added by |addEnterpriseRootCertificate| calls
     * from the local trust store.
     */
    @CalledByNativeUnchecked
    public static void clearEnterpriseRootCertificates() throws NoSuchAlgorithmException,
            CertificateException, KeyStoreException {
        X509Util.clearEnterpriseRootCertificates();
    }
