...
class CORE_EXPORT Document : public ContainerNode,
 ...
 public:
  ...
  void setIsDefaultExtraStyleSheet01Enabled(bool extra_stylesheet_enabled) {
    m_isDefaultExtraStyleSheet01Enabled = extra_stylesheet_enabled;
  }
  void setIsDefaultExtraStyleSheet02Enabled(bool extra_stylesheet_enabled) {
    m_isDefaultExtraStyleSheet02Enabled = extra_stylesheet_enabled;
  }
  bool isDefaultExtraStyleSheet01Enabled() {
    return m_isDefaultExtraStyleSheet01Enabled;
  }
  bool isDefaultExtraStyleSheet02Enabled() {
    return m_isDefaultExtraStyleSheet02Enabled;
  }
  void insertScriptFilters(const String& scriptFilters,
                           bool inlineScript,
                           bool externalScript);
  bool canExecuteInlineScript(const String& scriptSrc);
 ...
 private:
  ...
  Vector<std::unique_ptr<ScriptRegexp>> m_inlineScriptRegexFilters;
  Vector<String> m_inlineScriptSubstrFilters;
  ...
  bool m_inlineScriptExecutionEnabled = true;
