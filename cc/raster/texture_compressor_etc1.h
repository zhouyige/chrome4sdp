...
template<class ColorType> inline void WriteColors444(uint8_t* block,
...
template<class ColorType> inline void WriteColors555(uint8_t* block,
                           const ColorType& color0,
                           const ColorType& color1) {
...
// channel.
template<class ColorType> inline ColorType MakeColor444Template(const float* bgr) {
...
// Wrapper for original client code
inline Color MakeColor444(const float* bgr) {
  return MakeColor444Template<Color>(bgr);
}
...
// channel.
template<class ColorType> inline ColorType MakeColor555Template(const float* bgr) {
...
inline Color MakeColor555(const float* bgr) {
  return MakeColor555Template<Color>(bgr);
}

template<class ColorType> class CC_EXPORT TextureCompressorETC1 : public TextureCompressor {
 public:
