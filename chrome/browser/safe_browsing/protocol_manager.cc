...
static bool kSbCellularUpdatesDisabledCmdLine = false;
...
SafeBrowsingProtocolManager::SafeBrowsingProtocolManager(
  ...
  if (base::CommandLine::ForCurrentProcess()->HasSwitch("disable-safebrowsing-cellular-update"))
    kSbCellularUpdatesDisabledCmdLine = true;
}

void SafeBrowsingProtocolManager::SetCellularUpdates(bool enabled) {
  kSbEnableCellularUpdates = enabled;
}

bool getCellularUpdatesEnabled() {
  return !kSbCellularUpdatesDisabledCmdLine && kSbEnableCellularUpdates;
}
