...
void StyleResolver::matchUARules(ElementRuleCollector& collector) {
  ...
  if (document().isDefaultExtraStyleSheet01Enabled() &&
      defaultStyleSheets.defaultExtraStyle01())
    matchRuleSet(collector, defaultStyleSheets.defaultExtraStyle01());

  if (document().isDefaultExtraStyleSheet02Enabled() &&
      defaultStyleSheets.defaultExtraStyle02())
