...
typedef void(GL_BINDING_CALL* glCompressedTexSubImage3DProc)(GLenum target,
                                                             ...
                                                             GLsizei imageSize,
                                                             const void* data);
typedef void(GL_BINDING_CALL* glCompressTextureProc)(void);
...
struct ProcsGL {
  ...
  glCompressTextureProc glCompressTextureFn;
...
class GL_EXPORT GLApi {
 public:
  ...
  virtual void glCompressedTexSubImage3DFn(GLenum target,
                                           ...
                                           GLsizei imageSize,
                                           const void* data) = 0;
  virtual void glCompressTextureFn(void) = 0;
...
#define glCompressTexture ::gl::g_current_gl_context->glCompressTextureFn
