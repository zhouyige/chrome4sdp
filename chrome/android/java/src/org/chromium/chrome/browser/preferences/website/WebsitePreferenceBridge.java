...
public abstract class WebsitePreferenceBridge {
    ...
    /**
     * @return the list of all sites that have XSS Defender modified
     */
    public static List<XSSDefenderInfo> getXSSDefenderInfo() {
        ArrayList<XSSDefenderInfo> list = new ArrayList<>();
        nativeGetXSSDefenderOrigins(list, false);
        return list;
    }

    /**
     * Inserts XSS Defender information into a list
     */
    @CalledByNative
    private static void insertXSSDefenderInfoIntoList(
            ArrayList<XSSDefenderInfo> list, String origin, String embedder) {
        list.add(new XSSDefenderInfo(origin, embedder, false));
    }
    ...
    static native void nativeSetSecureConnectSettingForOrigin(
            String origin, String embedder, int value, boolean isIncognito);
    private static native void nativeGetXSSDefenderOrigins(
            Object list, boolean managedOnly);
    static native int nativeGetXSSDefenderSettingForOrigin(
            String origin, String embedder, boolean isIncognito);
    static native void nativeSetXSSDefenderSettingForOrigin(
            String origin, String embedder, int value, boolean isIncognito);
