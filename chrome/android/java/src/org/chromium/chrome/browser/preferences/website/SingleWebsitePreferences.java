...
public class SingleWebsitePreferences extends PreferenceFragment
    ...
    public static final String PREF_XSS_DEFENDER_PERMISSION = "xss_defender_permission";
    ...
    public static Website mergePermissionInfoForTopLevelOrigin(
        ...
        for (Website other : websites) {
            ...
            if (merged.getWebRefinerInfo() == null && other.getWebRefinerInfo() != null &&
                    permissionInfoIsForTopLevelOrigin(other.getWebRefinerInfo(), origin)) {
                merged.setWebRefinerInfo(other.getWebRefinerInfo());
            }
            if (merged.getWebDefenderInfo() == null && other.getWebDefenderInfo() != null &&
                    permissionInfoIsForTopLevelOrigin(other.getWebDefenderInfo(), origin)) {
                merged.setWebDefenderInfo(other.getWebDefenderInfo());
            }
            if (merged.getSecureConnectInfo() == null && other.getSecureConnectInfo() != null &&
                    permissionInfoIsForTopLevelOrigin(other.getSecureConnectInfo(), origin)) {
                merged.setSecureConnectInfo(other.getSecureConnectInfo());
            }
            if (merged.getXSSDefenderInfo() == null && other.getXSSDefenderInfo() != null &&
                    permissionInfoIsForTopLevelOrigin(other.getXSSDefenderInfo(), origin)) {
                merged.setXSSDefenderInfo(other.getXSSDefenderInfo());
            }
