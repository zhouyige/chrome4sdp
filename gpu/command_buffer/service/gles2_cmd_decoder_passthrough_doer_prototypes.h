...
error::Error DoCompressedTexSubImage3D(GLenum target,
                                       ...
                                       GLsizei imageSize,
                                       const void* data);
error::Error DoCompressTexture(void);
...
error::Error DoStartTilingQCOM(GLuint x, GLuint y, GLuint width, GLuint height, GLbitfield preserveMask);
error::Error DoEndTilingQCOM(GLbitfield preserveMask);
