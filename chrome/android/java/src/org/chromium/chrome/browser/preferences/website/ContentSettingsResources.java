...
public class ContentSettingsResources {
    ...
    private static Map<Integer, ResourceItem> getResourceInfo() {
        ...
        if (sResourceInfo == null) {
            ...
            localMap.put(ContentSettingsType.CONTENT_SETTINGS_TYPE_XSS_DEFENDER,
                    new ResourceItem(R.drawable.img_deco_smartprotect_xss_defender,
                            R.string.xss_defender_title, R.string.xss_defender_title,
                            ContentSetting.ALLOW, ContentSetting.BLOCK,
                            R.string.xss_defender_about_text, R.
                            string.website_settings_category_disabled));
