...
public class TemplateUrlService {
        ...
        for (int i = 0; i < templateUrlCount; i++) {
            TemplateUrl templateUrl =
                usePartnerSearchEngines() ? nativeGetPartnerTemplateUrlAt(
                    ...
                    nativeGetTemplateUrlAt(mNativeTemplateUrlServiceAndroid, i);
     ...
     * Also called by PartnerSearchEngineManager to call back the listeners
     * after partner search engines are injected.
     */
    @CalledByNative
    public void templateUrlServiceLoaded() {
        ThreadUtils.assertOnUiThread();
        PartnerSearchEngineManager pSM = PartnerSearchEngineManager.getInstance();
        if (pSM!= null && !pSM.isSearchEnginesInjected()) {
    ...
    public void addSearchEngine(String title, String keyword, String searchUrl, String faviconUrl,
                                String contextualSearchUrl) {
        nativeAddSearchEngine(mNativeTemplateUrlServiceAndroid, title, keyword, searchUrl,
                faviconUrl, contextualSearchUrl);
    }
    ...
    private native void nativeAddSearchEngine(long nativeTemplateUrlServiceAndroid, String title,
            String keyword, String searchUrl, String faviconUrl, String contextualSearchUrl);
