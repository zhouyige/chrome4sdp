...
error::Error GLES2DecoderPassthroughImpl::DoCompressTexture(void) {
  return error::kNoError;
}
...
error::Error GLES2DecoderPassthroughImpl::DoStartTilingQCOM(GLuint x, GLuint y, GLuint width, GLuint height, GLbitfield preserveMask) {
  return error::kNoError;
}

error::Error GLES2DecoderPassthroughImpl::DoEndTilingQCOM(GLbitfield preserveMask) {
  return error::kNoError;
}
