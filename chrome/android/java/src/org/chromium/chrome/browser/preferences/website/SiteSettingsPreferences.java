...
public class SiteSettingsPreferences extends PreferenceFragment
    ...
    static final String XSS_DEFENDER_KEY = "xss_defender";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (CommandLine.getInstance().hasSwitch(ChromeSwitches.DISABLE_XSS_DEFENDER)) {
            getPreferenceScreen().removePreference(findPreference(XSS_DEFENDER_KEY));
        }
    ...
    private int keyToContentSettingsType(String key) {
        ...
        } else if (XSS_DEFENDER_KEY.equals(key)) {
    ...
    private void updatePreferenceStates() {
        ...
        if (mMediaSubMenu) {
            ...
            if (!CommandLine.getInstance().hasSwitch(ChromeSwitches.DISABLE_XSS_DEFENDER)) {
                websitePrefs.add(XSS_DEFENDER_KEY);
            }
        ...
        for (String prefName : websitePrefs) {
            ...
            } else if (XSS_DEFENDER_KEY.equals(prefName)) {
                checked = PrefServiceBridge.getInstance().isXSSDefenderEnabled();
            }
            ...
            if (AUTOPLAY_KEY.equals(prefName)
                ...
                p.setSummary(ContentSettingsResources.getGeolocationAllowedSummary());
                    ...
                    || SECURE_CONNECT_KEY.equals(prefName) || XSS_DEFENDER_KEY.equals(prefName)) {
