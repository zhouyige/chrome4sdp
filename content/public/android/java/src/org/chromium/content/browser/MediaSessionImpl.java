...
public class MediaSessionImpl extends MediaSession {
    ...
    @Override
    public void deltaSeek(int delta) {
        nativeDeltaSeek(mNativeMediaSessionAndroid, delta);
    }
    ...
    private native void nativeDeltaSeek(long nativeMediaSessionAndroid, int delta);
