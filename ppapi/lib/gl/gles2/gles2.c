...
void GL_APIENTRY glStartTilingQCOM(GLuint x,
                                   GLuint y,
                                   GLuint width,
                                   GLuint height,
                                   GLbitfield preserveMask) {
  glGetInterfacePPAPI()->StartTilingQCOM(glGetCurrentContextPPAPI(), x, y,
                                         width, height, preserveMask);
}

void GL_APIENTRY glEndTilingQCOM(GLbitfield preserveMask) {
  glGetInterfacePPAPI()->EndTilingQCOM(glGetCurrentContextPPAPI(),
                                       preserveMask);
}

void GL_APIENTRY glCompressTexture() {
  glGetInterfacePPAPI()->CompressTexture(glGetCurrentContextPPAPI());
}
