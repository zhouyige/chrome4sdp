...
struct CompressTexture {
  typedef CompressTexture ValueType;
  static const CommandId kCmdId = kCompressTexture;
  static const cmd::ArgFlags kArgFlags = cmd::kFixed;
  static const uint8_t cmd_flags = CMD_FLAG_SET_TRACE_LEVEL(2);
...
static_assert(sizeof(CompressTexture) == 4,
              "size of CompressTexture should be 4");
static_assert(offsetof(CompressTexture, header) == 0,
              "offset of CompressTexture header should be 0");
