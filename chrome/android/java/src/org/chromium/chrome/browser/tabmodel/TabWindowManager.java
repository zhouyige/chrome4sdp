...
public class TabWindowManager implements ActivityStateListener {
    ...
    /**
     * @return All the models known to the manager.
     */
    public List<TabModel> getModels() {
        List<TabModel> models = new ArrayList<>();
        for (TabModelSelector modelSelector : mSelectors) {
            if (modelSelector == null) continue;
                models.addAll(modelSelector.getModels());
        }
        return models;
    }
