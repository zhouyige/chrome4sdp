...
public class FirstRunActivity extends AppCompatActivity implements FirstRunPageDelegate {
    ...
    static final String SHOW_XSS_DEFENDER_PAGE = "ShowXSSDefenderPage";
    ...
    private void createPageSequence() {
        ...
        if (mFreProperties.getBoolean(SHOW_XSS_DEFENDER_PAGE)) {
            mPages.add(pageOf(XSSDefenderFirstRunFragment.class));
        }
