...
const char kEnterpriseTrust[] = "enterprise.root_trust";

const char kEnterpriseDomains[] = "enterprise.domains";

const char kEnterpriseUserCredentials[] = "enterprise.user_credentials";
