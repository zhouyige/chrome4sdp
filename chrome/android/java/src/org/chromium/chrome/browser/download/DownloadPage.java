 ...
 */
public class DownloadPage extends BasicNativePage implements InvalidationAwareThumbnailProvider,
    ...
    protected void initialize(Activity activity, final Tab tab) {
        ...
        mManager.addDrawerListener(this);
    ...
    @Override
    public boolean shouldCaptureThumbnail() { return mNeedsCapture; }
