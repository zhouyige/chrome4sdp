...
class TemplateUrlServiceAndroid : public TemplateURLServiceObserver {
 public:
  TemplateUrlServiceAndroid(JNIEnv* env, jobject obj, jboolean is_incognito);
  ...
  base::android::ScopedJavaLocalRef<jobject>
      GetPartnerTemplateUrlAt(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj, jint index);
