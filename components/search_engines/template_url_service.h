...
class TemplateURLService : public WebDataServiceConsumer,
 ...
 public:
  ...
  // prepopulate data.
  void RepairPrepopulatedSearchEngines(bool search_engines_injected = false);
 ...
 private:
  ...
  // Holds the regular or incognito synced default search provider guid as per the profile
  const char *synced_default_search_provider_guid_;
